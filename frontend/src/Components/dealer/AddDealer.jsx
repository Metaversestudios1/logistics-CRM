  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/createDealer`,
        {
          method: "POST",
      ...
      if (response.success) {
        toast.success("New Dealer is added Successfully!", {
          position: "top-right",
          autoClose: 1000,
  ...
  return (
    <>
      <div className="flex items-center ">
        ...
        <div className="flex items-center">
          <div className="text-2xl font-bold mx-2 my-8 px-4">Add Dealer</div>
        </div>
      </div>
      {loader ? (
        ...
        <div className="w-[70%] m-auto my-10">
          <form id="dealerForm">
            ...
            <h2 className="font-bold text-lg mt-8 mb-4">Bussiness Details - </h2>
            <div className="grid gap-6 mb-6 md:grid-cols-2 items-center">
            <div>
                <label
