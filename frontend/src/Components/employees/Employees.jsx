...
const Employees = () => {
  ...
  const fetchData = async () => {
    ...
    const res = await fetch(
      `${import.meta.env.VITE_BACKEND_URL}/api/getAllEmployees?page=${page}&limit=${pageSize}&search=${search}`
    );
  ...
  const handleDelete = async (e, id) => {
    ...
    if (permissionOfDelete) {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/deleteEmployee`, {
        method: "DELETE",
